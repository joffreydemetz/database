...
use JDZ\Database\Table\TableRow;
...
interface DatabaseInterface 
{
   ...
   * @param  TableRow  $row      Table Row instance
   ...
   * @param  TableRow  $row      Table Row instance
   * @param  string    $key      PK name
   * @param  bool      $nulls    Update null fields
   * @return bool  True on success
   * @throws QueryException
   */
   ...
   * @param  bool     $full      True to only return full column infos
